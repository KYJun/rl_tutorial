...
parser.add_argument("-ld", "--logdir", type=str, default=os.path.join(os.getcwd(), "ac_pong_log"), help="log data directory")
...
parser.add_argument("-hd", "--hidden_dim", type=int, default=32, help="hidden layer dim")
...
parser.add_argument("--max_buffer_size", type=int, default=5, help="max experience buffer size")
parser.add_argument("-pts", "--preTrainStep", type=int, default=5, help="steps for pre training")
parser.add_argument("--ddpg", type=bool, default=True, help="Apply DDPG network")
